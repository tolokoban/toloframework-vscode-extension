...
var PlainValue = __webpack_require__(/*! ./PlainValue-ec8e588e.js */ "./node_modules/yaml/dist/PlainValue-ec8e588e.js");
var resolveSeq = __webpack_require__(/*! ./resolveSeq-4a68b39b.js */ "./node_modules/yaml/dist/resolveSeq-4a68b39b.js");
var Schema = __webpack_require__(/*! ./Schema-42e9705c.js */ "./node_modules/yaml/dist/Schema-42e9705c.js");
...
var PlainValue = __webpack_require__(/*! ./PlainValue-ec8e588e.js */ "./node_modules/yaml/dist/PlainValue-ec8e588e.js");
var resolveSeq = __webpack_require__(/*! ./resolveSeq-4a68b39b.js */ "./node_modules/yaml/dist/resolveSeq-4a68b39b.js");
var warnings = __webpack_require__(/*! ./warnings-39684f17.js */ "./node_modules/yaml/dist/warnings-39684f17.js");
...
var PlainValue = __webpack_require__(/*! ./PlainValue-ec8e588e.js */ "./node_modules/yaml/dist/PlainValue-ec8e588e.js");
var parseCst = __webpack_require__(/*! ./parse-cst.js */ "./node_modules/yaml/dist/parse-cst.js");
__webpack_require__(/*! ./resolveSeq-4a68b39b.js */ "./node_modules/yaml/dist/resolveSeq-4a68b39b.js");
var Document$1 = __webpack_require__(/*! ./Document-2cf6b08c.js */ "./node_modules/yaml/dist/Document-2cf6b08c.js");
var Schema = __webpack_require__(/*! ./Schema-42e9705c.js */ "./node_modules/yaml/dist/Schema-42e9705c.js");
var warnings = __webpack_require__(/*! ./warnings-39684f17.js */ "./node_modules/yaml/dist/warnings-39684f17.js");
...
module.exports = __webpack_require__(/*! ./dist */ "./node_modules/yaml/dist/index.js").YAML
...
const util = __webpack_require__(/*! ./dist/util */ "./node_modules/yaml/dist/util.js")
...
function activate(context) {
    ...
    for (const action of actions) {
        ...
        const disposable = VSC.commands.registerCommand(id, () => switchTo(extension, viewColumn));
...
function switchTo(extension, viewColumn) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (yield openFileIfExists(extension, viewColumn, activeEditor))
            return;
        // File does not exist.
        // We need to create it.
        const filename = util_1.default.changeExtension(activeEditor.document.fileName, extension);
        util_1.default.writeTextFile(filename, getInitialContent(extension, activeEditor.document.fileName));
        const doc = yield util_1.default.openTextDocument(filename);
        if (doc !== null) {
...
function openFileIfExists(extension, viewColumn, activeEditor) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const ext of extensions) {
            const filename = util_1.default.changeExtension(activeEditor.document.fileName, ext);
            if (!util_1.default.exists(filename))
                continue;
            const doc = yield util_1.default.openTextDocument(filename);
            if (doc === null)
                return false;
...
function getInitialContent(extension, originFileName) {
    switch (extension) {
        case "yaml": return getInitialContentYAML(originFileName);
    }
    return "";
}
function getInitialContentYAML(originFileName) {
    return "en:\n    cancel: Cancel\n    ok: Ok\nfr:\n    cancel: Annuler\n    ok: Valider\n";
}
...
const util_1 = __webpack_require__(/*! ../util */ "./src/util.ts");
const slicer_1 = __webpack_require__(/*! ./slicer */ "./src/fonts/slicer.ts");
...
function load() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const fontURL = yield X.window.showInputBox({
            ...
            if (!fontName)
                return;
            const cssContent = yield asyncContentLoading;
            disposableMessage.dispose();
            if (!cssContent)
                return;
            const asyncLoadAll = loadAllFonts(cssContent);
            const destination = yield inputs_1.default.selectFolder();
            X.window.showInformationMessage(destination || "NULL");
            if (!destination)
                return;
            const path = Path.resolve(destination, fontName);
            if (FS.existsSync(path)) {
                X.window.showErrorMessage(`This directory already exists:\n${path}`, { modal: true });
                return;
            }
            yield X.workspace.fs.createDirectory(X.Uri.file(path));
            const files = yield asyncLoadAll;
            for (const fontFile of files.fonts) {
                if (!fontFile.data)
                    continue;
                FS.writeFileSync(Path.resolve(path, fontFile.filename), new Uint8Array(fontFile.data));
            }
            const cssFilename = Path.resolve(path, `${fontName}.css`);
            FS.writeFileSync(cssFilename, files.css);
            yield util_1.default.openFileInEditor(cssFilename, X.ViewColumn.Active);
            const fontClassFilename = Path.resolve(path, "..", "font.ts");
            if (FS.existsSync(fontClassFilename)) {
                FS.writeFileSync(Path.resolve(path, "index.ts"), `export { default } from './${fontName}'\n`);
                const modFilename = Path.resolve(path, `${fontName}.ts`);
                FS.writeFileSync(modFilename, `import FontClass from '../font'
import './${fontName}.css'

// @TODO Check the font name in the CSS file: "${fontName}.css"
export default new FontClass("${fontName}")
`);
                yield util_1.default.openFileInEditor(modFilename, X.ViewColumn.Beside);
            }
            else {
            ...
            X.window.showErrorMessage(`${ex}`, { modal: true });
        }
    });
}
function getCurrentURI() {
    ...
    if (editor) {
        const path = Path.dirname(editor.document.fileName);
...
function loadContentFromURL(url) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const styleResponse = yield node_fetch_1.default(url);
            const styleContent = yield styleResponse.text();
            return styleContent;
        }
        catch (ex) {
...
function loadAllFonts(cssContent) {
    return __awaiter(this, void 0, void 0, function* () {
        const slices = slicer_1.default.slice(cssContent);
        ...
        for (let i = 0; i < slices.urls.length; i++) {
            ...
            try {
                ...
                X.window.showErrorMessage(`Unable to load font ${i + 1} / ${slices.urls.length}:\n${url}\n\n${ex}`);
            }
        }
        disposableMessage.dispose();
        return {
...
var fonts_1 = __webpack_require__(/*! ./fonts */ "./src/fonts/fonts.ts");
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return fonts_1.default; } });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = void 0;
var inputs_1 = __webpack_require__(/*! ./inputs */ "./src/inputs/inputs.ts");
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return inputs_1.default; } });
...
function selectFolder(title = "Select a folder for the font") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            const sourceFolder = util_1.default.getSourceFolder();
            if (!sourceFolder) {
...
function recursiveSearchForFolders(currentFolder, folders) {
...
const util_1 = __webpack_require__(/*! yaml/util */ "./node_modules/yaml/util.js");
const util_2 = __webpack_require__(/*! ./util */ "./src/util.ts");
exports.default = { compileYAML };
const DEFAULT_INDENTATION = "    ";
const NOT_FOUND = -1;
function isYamlException(ex) {
    if (!ex)
        return false;
    if (typeof ex !== 'object')
        return false;
    if (typeof ex.makePretty !== 'function')
        return false;
    return true;
}
function compileYAML() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (ex instanceof util_1.YAMLSemanticError) {
                errorMessage = `YAML Semantic Error at line ${(_a = ex.linePos) === null || _a === void 0 ? void 0 : _a.start.line}!\n${ex.message}\n`;
            }
            else if (ex instanceof util_1.YAMLError) {
        ...
        const destination = util_2.default.changeExtension(filename, "json");
        util_2.default.writeTextFile(destination, JSON.stringify(value, null, DEFAULT_INDENTATION));
        yield util_2.default.openFileInEditor(destination);
    });
}
...
var IViewColumn;
(function (IViewColumn) {
    IViewColumn[IViewColumn["ACTIVE"] = -1] = "ACTIVE";
    IViewColumn[IViewColumn["BESIDE"] = -2] = "BESIDE";
    IViewColumn[IViewColumn["ONE"] = 1] = "ONE";
    IViewColumn[IViewColumn["TWO"] = 2] = "TWO";
...
function openTextDocument(filename) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            X.workspace.openTextDocument(filename).then(resolve, reject);
        });
    });
}
function openFileInEditor(filename, viewColumn = X.ViewColumn.Active) {
    return __awaiter(this, void 0, void 0, function* () {
        const doc = yield openTextDocument(filename);
        if (!doc)
            return false;
        X.window.showTextDocument(doc, viewColumn.valueOf());
        return true;
    });
}
 ...
 */
function findFilenameInAncestors(filename, startingPath) {
...
function getSourceFolder() {
    const editor = X.window.activeTextEditor;
    if (editor)
        return getSourceFolderFromActiveTextEditor(editor);
    return null;
}
function getSourceFolderFromActiveTextEditor(editor) {
